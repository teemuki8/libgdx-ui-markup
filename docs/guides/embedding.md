...
All coordinates are published artifacts. Markup modules track the markup release (0.2.0 at the
time of writing); harness and agent-runtime are fixed dependencies of that release.

| Coordinate | Version | Provides |
|---|---|---|
| `io.github.teemuki8:libgdx-ui-markup` | 0.2.0 | `MarkupBuilder`, parser, CSS engine, `DefaultSkin` |
| `io.github.teemuki8:libgdx-ui-markup-harness` | 0.2.0 | `HarnessSemanticSink` |
| `io.github.teemuki8:libgdx-ui-markup-runtime` | 0.2.0 | `MarkupRuntimeSource` |
