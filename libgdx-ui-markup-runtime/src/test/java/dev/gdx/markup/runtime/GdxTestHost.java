 ...
 * Assertions thrown inside the body are captured and rethrown on the test thread.
 */
final class GdxTestHost {
    ...
    static void run(TestBody body) throws Exception {
        ...
        config.setTitle("gdx-ui-markup-runtime-test");
        ...
        }, "gdx-ui-markup-runtime-test-main");
        main.start();
